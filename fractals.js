...
const utilsLog = require('./utils_log.js')
...
function main () {
  ...
  void main()
  {
    vec2 uv = gl_FragCoord.xy - vec2(1080.0,1080.0) * 0.5;
    uv *= 2.5 / min( 1080.0, 1080.0 );
#if 0 // Mandelbrot
    vec2 c = uv;
    vec2 v = vec2( 0.0 );
    float scale = 0.06;
  ...
  var filename = 'fractals.ppm' // eslint-disable-line
